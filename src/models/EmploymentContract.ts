...
import IEmploymentContract from '../interfaces/EmploymentContract';

const employmentContractSchema = new Schema<IEmploymentContract>(
    {
        contractType: String,
        workName: String,
        numberOfHour: Number,
...
const EmploymentContract = model<IEmploymentContract>('EmploymentContract', employmentContractSchema);
